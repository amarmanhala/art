    ...
    <main className="mx-auto flex max-w-4xl flex-col gap-6 px-6 py-14">
      ...
      <div className="flex flex-col gap-5 text-lg leading-8 text-muted-foreground">
        ...
        <p>
          ...
          design, offering prints that feel considered, calm, and personal.
        </p>
        <p>
          Each piece is produced with care after an order is placed, helping us
          reduce waste while keeping the focus on quality and intentional
          craftsmanship.
        </p>
      </div>
    </main>
